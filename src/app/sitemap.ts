...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: 'https://sachkundenachweis-online.at/st-poelten',
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    {
      url: 'https://sachkundenachweis-online.at/tulln',
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    {
      url: 'https://sachkundenachweis-online.at/baden',
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    {
      url: 'https://sachkundenachweis-online.at/wiener-neustadt',
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    {
      url: 'https://sachkundenachweis-online.at/moedling',
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.7,
    },
